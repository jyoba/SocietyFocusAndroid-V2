...
import com.zircon.app.ui.login.SocietySelectionFragment;
        ...
        public ViewHolder( View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    BottomSheetDialogFragment bottomSheetDialogFragment = new UserDetailFragment();
                    bottomSheetDialogFragment.show(((BaseActivity)v.getContext()).getSupportFragmentManager(), bottomSheetDialogFragment.getTag());
//                    membersList.get(getAdapterPosition());
        ...
        public void setUser(User user) {
            ...
            TextDrawable td = new TextDrawable(itemView.getContext());
            td.setText(user.firstname.substring(0,1).toUpperCase());
            td.setTextColor(Color.WHITE);
            Picasso.with(profileImageView.getContext()).load(user.profilePic).placeholder(td).fit().into(profileImageView);

            Random rnd = new Random();
            int color = Color.argb(255, rnd.nextInt(256), rnd.nextInt(256), rnd.nextInt(256));
            profileImageView.setBackgroundColor(color);

            String name = (user.firstname + " " + (user.lastname != null ? user.lastname : "")).toUpperCase();
